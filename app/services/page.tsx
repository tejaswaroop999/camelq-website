...
import { ChevronRight, Code, Database, LineChart, Laptop, Server, Shield, Activity } from "lucide-react"
      ...
      <section className="container px-4 md:px-6 pt-12 pb-24">
        <Fade direction="up">
          <div className="max-w-3xl mx-auto justify-items-center text-center mb-20">
            ...
            <p className="mt-6 text-xl text-black-700 dark:text-gray-300">
              We provide a comprehensive range of software solutions tailored to meet your business needs.
            </p>
          </div>
        </Fade>
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-4xl mx-auto justify-items-center text-center">
              ...
              <p className="mt-4 text-lg text-gray-700 dark:text-gray-300 mb-8">
                Contact us today for a free consultation and let us help you bring your ideas to life.
              </p>
              <Link href="/contact">
                <Button
                  size="lg"
