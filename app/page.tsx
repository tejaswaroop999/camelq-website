  ...
  const team = [
    {
      ...
      bio: "Alex has over 15 years of experience in software development and business leadership. He founded CamelQ with a vision to create innovative software solutions.",
      socialLinks: {
        linkedin: "#",
        twitter: "#",
        email: "alex@camelq.com",
      },
    },
    {
      name: "Sarah Williams",
      position: "CTO",
      image: "/our-team/hr.jpg?height=300&width=300",
      bio: "Sarah leads our technical team with her extensive knowledge in cloud architecture and software engineering. She ensures our solutions are cutting-edge.",
      socialLinks: {
        linkedin: "#",
        twitter: "#",
    ...
    },
    {
      ...
      image: "/our-team/manger.jpg?height=300&width=300",
      bio: "Michael is an expert in full-stack development with a passion for creating elegant, efficient code. He oversees all development projects.",
      socialLinks: {
        linkedin: "#",
        twitter: "#",
    ...
    },
    {
      ...
      image: "/clients-feedback/preson1.jpg?height=300&width=300",
      bio: "Jessica brings creativity and user-centered design principles to every project, ensuring our solutions are not just functional but delightful to use.",
      socialLinks: {
        linkedin: "#",
        twitter: "#",
